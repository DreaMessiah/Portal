            ...
            <div className={`new_controll_form`}>
                <div className='new_controll_form_this'>
                    ...
                    {connections.map( (item,index) => (
                        <div key={index} className='new_controll_form_this_strock view-connections'>
                            <div className='new_controll_form_this_strock_number'><input disabled={!onRigthStatus} value={item.num} onChange={(e) => numHandler(e.target.value,index)} className={`input_form`} id='number' type="text" /></div>
                            <div className='new_controll_form_this_strock_shifr'><input disabled={!onRigthStatus} value={item.codecrew} onChange={(e) => codecrewHandler(e.target.value,index)} className='input_form' id='shifr' type="text" /></div>
                            <div className='new_controll_form_this_strock_date'><TableDatePicker disabled={!onRigthStatus} size={'100%'} value={item.date} placeholder={'Выберете дату'} onChange={dateHandler} index={index} /></div>
                            <div className='new_controll_form_this_strock_way'><input disabled={!onRigthStatus} value={item.way} onChange={(e) => wayHandler(e.target.value,index)} className='input_form' id='way' type="text" /></div>
                            <div className='new_controll_form_this_strock_access'><input disabled={!onRigthStatus} value={item.dostup} onChange={(e) => dostupHandler(e.target.value,index)} className='input_form' id='access' type="text" /></div>
                            <div className='new_controll_form_this_strock_size'><input disabled={!onRigthStatus} value={item.size} onChange={(e) => sizeHandler(e.target.value,index)} className='input_form' id='size' type="text" /></div>
                            <div className='new_controll_form_this_strock_tube'><input disabled={!onRigthStatus} value={item.zav} onChange={(e) => zavHandler(e.target.value,index)} className='input_form' id='tube' type="text" /></div>
                        </div>
                    ))}
                </div>
