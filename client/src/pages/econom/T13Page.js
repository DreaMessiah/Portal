        ...
        try{
            ...
            reader.onload = async (event) => {
                ...
                if(month){
                    ...
                    const json = rows.map(item => {return item[1] ? {name:item[1],developer:item[3],branch:item[2],onboard:convertNumberToDate(item[7]),term:item[8] ? convertNumberToDate(item[8]) : '',document:'',tn:item[5],rk:'',groups:item[10],sn:item[11],status:'',gender:item[12],oklad:item[15],method:item[9],month:month,year:year,inn:store.user.inn,birthday:convertNumberToDate(item[13]),d1:days.includes(item[16]) ? item[16] : '',d2:days.includes(item[17]) ? item[17] : '',d3:days.includes(item[18]) ? item[18] : '',d4:days.includes(item[19]) ? item[19] : '',d5:days.includes(item[20]) ? item[20] : '',d6:days.includes(item[21]) ? item[21] : '',d7:days.includes(item[22]) ? item[22] : '',d8:days.includes(item[23]) ? item[23] : '',d9:days.includes(item[24]) ? item[24] : '',d10:days.includes(item[25]) ? item[25] : '',d11:days.includes(item[26]) ? item[26] : '',d12:days.includes(item[27]) ? item[27] : '',d13:days.includes(item[28]) ? item[28] : '',d14:days.includes(item[29]) ? item[29] : '',d15:days.includes(item[30]) ? item[30] : '',d16:days.includes(item[31]) ? item[31] : '',d17:days.includes(item[32]) ? item[32] : '',d18:days.includes(item[33]) ? item[33] : '',d19:days.includes(item[34]) ? item[34] : '',d20:days.includes(item[35]) ? item[35] : '',d21:days.includes(item[36]) ? item[36] : '',d22:days.includes(item[37]) ? item[37] : '',d23:days.includes(item[38]) ? item[38] : '',d24:days.includes(item[39]) ? item[39] : '',d25:days.includes(item[40]) ? item[40] : '',d26:days.includes(item[41]) ? item[41] : '',d27:days.includes(item[42]) ? item[42] : '',d28:days.includes(item[43]) ? item[43] : '',d29:days.includes(item[44]) ? item[44] : '',d30:days.includes(item[45]) ? item[45] : '',d31:days.includes(item[46]) ? item[46] : ''} : null})
