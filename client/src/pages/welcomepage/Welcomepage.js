            ...
            <div className='imgback'>
                <div className='welcomepage_white'>
                    <div className="welcomepage_white_mess">
                        ...
                        Вместе мы не только достигнем новых высот в бизнесе, но и продолжим поддерживать атмосферу взаимоуважения и поддержки, которая является залогом нашего с Вами успеха. Желаю Вам новых профессиональных достижений и надеюсь, что работа в ООО «Сургутское РСУ» принесет каждому стабильность и откроет новые перспективы.
                        <br/><b>С уважением,<br/>
